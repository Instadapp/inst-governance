...
contract PayloadIGP52 {
    uint256 public constant PROPOSAL_ID = 52;
    ...
    function execute() external {
        ...
        // Action 1: Add 0.5M Rewards to fUSDC and fUSDT
        action1();
    ...
    /// @notice Action 1: Add 0.5M Rewards to fUSDC and fUSDT
    function action1() internal {
        ...
        address REWARDS_ADDRESS = address(
            0x19147A180D271d90dC12Da2BFFC636F54Cf7C241
        );
    ...
    /// @notice Action 2: Set ETH-weETH dex pool and vault initial limits.
    function action2() internal {
        {
            ...
            DEX_FACTORY.setDexAuth(getDexAddress(9), TEAM_MULTISIG, true);
        }
