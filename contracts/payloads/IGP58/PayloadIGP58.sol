...
contract PayloadIGP58 {
    uint256 public constant PROPOSAL_ID = 58;
    ...
    function action1() internal {
        ...
        string memory approveSignature = "approve(address,address,uint256,uint256,uint256)";

        // Spell 1: Approve Aave Governance Executor 1.145M INST
        {   
            uint256 INST_AMOUNT = 1_145_000 * 1e18; // 1.145M INST
            targets[0] = "BASIC-E";
            encodedSpells[0] = abi.encodeWithSignature(approveSignature, INST_ADDRESS, AAVE_EXECUTOR_ADDRESS, INST_AMOUNT, 0, 0);
        }
