...
interface ISmartLendingAdmin {
    ...
    ///         Only callable by SmartLendingFactory auths.
    ...
    /// @notice Balances out the difference between fSLToken supply at Liquidity vs totalAssets().
    ...
    ///         Callable by anyone.
    /// @return tokenExchangePrice_ exchange price of fSLToken share to underlying asset
    ...
    /// @notice sends any potentially stuck funds to Liquidity contract. Only callable by SmartLendingFactory auths.
