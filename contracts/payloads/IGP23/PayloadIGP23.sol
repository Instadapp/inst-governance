...
contract PayloadIGP23 {
    ...
    function execute() external {
        ...
        // Action 1: call cast() - transfer rewards to Team Multisig from treasury.
        action1();

        // Action 2: Update rewards for fUSDC & fUSDT.
        action2();
    }
    ...
    function action1() public view returns(address target, uint256 value, string memory signature, bytes memory calldatas) {
        ...
        // Spell 2: Transfer INST
        {   
            address INST_ADDRESS = 0x6f40d4A6237C257fff2dB00FA0510DeEECd303eb;
            uint256 INST_AMOUNT = 160_000 * 1e18; // 160k INST
            targets[1] = "BASIC-A";
