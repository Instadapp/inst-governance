...
contract PayloadIGP53 {
    uint256 public constant PROPOSAL_ID = 53;
    ...
    function execute() external {
        ...
        // Action 1: Collect Revenue from Liquidity Layer
        action1();

        // Action 2: Set ETH-weETH dex pool and vault launch limits.
        action2();
    ...
    /// @notice Action 1: Collect Revenue from Liquidity Layer
    ...
    /// @notice Action 2: Set ETH-weETH dex pool and vault launch limits.
    function action2() internal {
        {
            // ETH-weETH
            Dex memory DEX_ETH_WEETH = Dex({
                dex: getDexAddress(9),
                tokenA: ETH_ADDRESS,
            ...
            setDexLimits(DEX_ETH_WEETH); // Smart Collateral

            DEX_FACTORY.setDexAuth(getDexAddress(9), TEAM_MULTISIG, false);
        }
