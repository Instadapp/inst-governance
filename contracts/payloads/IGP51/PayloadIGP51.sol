...
contract PayloadIGP51 {
    uint256 public constant PROPOSAL_ID = 51;
    ...
    function execute() external {
        ...
        // Action 1: Add new LendingRewards contracts
        action1();

        // Action 2: Update USDC and USDT market rates.
        action2();
    }
    ...
    /// @notice Action 1: Add new LendingRewards contracts
    function action1() internal {
        ...
        { /// fUSDC
            IFTokenAdmin(F_USDC).updateRewards(
                0x1E80FFf32BD4b6304EAEc2e72832CCdBe85179Aa
            );
        ...
        {
            ILendingRewards(0x1E80FFf32BD4b6304EAEc2e72832CCdBe85179Aa).start();
        }
    }

    /// @notice Action 2: Update USDC and USDT market rates.
    function action2() internal {
        AdminModuleStructs.RateDataV2Params[] memory params_ = new AdminModuleStructs.RateDataV2Params[](2);
